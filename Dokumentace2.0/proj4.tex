...
\paragraph{EX - Střední hodnota} Střední hodnotu jsme zjistili z četnosti výskytů hodnot na intervalu (obrázek \textbf{číslo \ref{sec:obr3}}) pro danou vytvořenou funkce.
 ???????????????? 
